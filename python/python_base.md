...
* `str.join([список])` - возвращает строку, собранную из элементов указанного объекта, поддерживающего итерирование.
...
* `str.replace(старое, новое)` - возвращает копию строки, в которой заменяет одну подстроку на другую.
