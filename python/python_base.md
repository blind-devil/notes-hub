...
* [Оператор pass](#оператор_pass)

**Работа с данными:**

* [Типы данных](#типы_данных)
* [type()](#type)
* [int(), float(), str()](#int_float_str)
...
* [Добавление и повторение](#добавление_и_повторение)
* [Методы объекта строки](#методы_объекта_строки)
...
* [Определение](#списки_и_кортежи)
* [list()](#list)
* [tuple()](#tuple)
* [Индексация](#индексация)
* [Добавление и повторение](#добавление_и_повторение)
* [Включение в список](#включение_в_список)
* [Двумерный список](#двумерный_список)
* [enumerate()](#enumerate)
* [min() и max()](#min_и_max)
* [del](#del)
* [Методы объекта списка](#методы_объекта_списка)

**Работа со словарями:**

* [Определение](#словари)
* [dict()](#dict)
* [Манипуляции с элементами в словаре](#манипуляции_с_элементами_в_словаре)
* [Включение в словарь](#включение_в_словарь)
* [Методы объекта словаря](#методы_объекта_словаря)

**Работа со множествами:**

* [Определение](#множества)
* [set()](#set)
* [Включение в множество](#включение_в_множество)
* [Методы объекта множества](#методы_объекта_множества)
...
### <a name='именование'></a> Именование [🠕](#🠕)

`Hi` `tool_01` `_name1` `BigOne`

~~`25tor`~~ ~~`your name`~~ ~~`keyword`~~

### <a name='ключевые_слова'></a> Ключевые слова [🠕](#🠕)
...
### <a name='int_float_str'></a> int(), float(), str() [🠕](#🠕)
...
### <a name='оператор_pass'></a> Оператор pass [🠕](#🠕)
...
### <a name='исключения'></a> Исключения [🠕](#🠕)
...
### <a name='списки_и_кортежи'></a> Списки и кортежи [🠕](#🠕)
...
### <a name='индексация'></a> Индексация [🠕](#🠕)

Все символы в списке/кортеже или строке имеют свой порядковый номер(индекс). Первый символ имеет индекс 0, второй символ - индекс 1, третий - индекс 2 и т.д.
...
### <a name='добавление_и_повторение'></a> Добавление и повторение [🠕](#🠕)
...
Добавление нескольких строк к строке:

```python
x = 'My'
x += 'Name' + 'Is'
print(x)                         # Вывод будет "MyNameIs"
```
...
### <a name='включение_в_список'></a> Включение в список [🠕](#🠕)
...
### <a name='двумерный_список'></a> Двумерный список [🠕](#🠕)
...
### <a name='методы_объекта_списка'></a> Методы объекта списка [🠕](#🠕)
...
### <a name='методы_объекта_строки'></a> Методы объекта строки [🠕](#🠕)
...
### <a name='манипуляции_с_элементами_в_словаре'></a> Манипуляции с элементами в словаре [🠕](#🠕)
...
### <a name='включение_в_словарь'></a> Включение в словарь [🠕](#🠕)
...
### <a name='методы_объекта_словаря'></a> Методы объекта словаря [🠕](#🠕)
...
* `dict.update()` - обновляет словарь элементами из другого объекта словаря или из итерации пар `ключ: значение`.

### <a name='множества'></a> Множества [🠕](#🠕)
...
### <a name='включение_в_множество'></a> Включение в множество [🠕](#🠕)
...
### <a name='методы_объекта_множества'></a> Методы объекта множества [🠕](#🠕)
